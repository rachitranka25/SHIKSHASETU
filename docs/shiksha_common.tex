...
\begin{tikzpicture}[
  ...
  loc/.style  ={stage, fill=black!5,  text width=27mm},
  net/.style  ={stage, fill=black!14, text width=27mm},
...
\draw[dashed, black!55] (32mm,4mm) -- (32mm,-46mm);
\node[t, anchor=south, black!65] at (14mm,4.5mm) {\textsc{this machine}};
\node[t, anchor=south, black!65] at (52mm,4.5mm) {\textsc{network}};
