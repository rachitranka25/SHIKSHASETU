...
\begin{enumerate}
\item A complete ingestion pipeline for 559 NCERT textbooks, with automatic detection and rejection of legacy-font corruption that renders 27 of 41 Hindi books unreadable---discovered only through measurement.
...
Full curriculum time & ${\sim}7$ hours \\
...
This paper presented Shiksha Setu, a local-first AI tutoring platform processing the complete NCERT curriculum of 559 textbooks and delivering instruction in ten Indian languages on consumer hardware with as little as 4~GB of RAM. Every performance claim has been substantiated through kernel-level measurement, and engineering failures have been documented alongside their corrections.
