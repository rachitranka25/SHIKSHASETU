...
import { Plus, MessageSquare, Trash2, Settings, LogOut, X, Search, AlertTriangle, Menu, BookOpen, GraduationCap } from 'lucide-react';
    ...
    <>
      ...
      >
        ...
        <div className={`p-3 ${isDark ? 'border-t border-white/10' : 'border-t border-gray-200'}`}>
          ...
          {/* Learn and Library are both public, so they sit above the account row */}
          <button
            ...
            aria-label="Learn a topic from the textbooks"
          >
